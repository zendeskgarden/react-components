...
`+e.id,s=Yt.get(i);return s||(s=Ut(o.absoluteBoundingBox,e.absoluteBoundingBox),Yt.set(i,s)),[...s.map(n=>lr({guide:n,reverseScale:t})),...s.map(n=>cr({guide:n,reverseScale:t,fontSize:r}))]},Gt=A`
  .distance-line {
    shape-rendering: geometricPrecision;
    fill: none;
    opacity: 0;
...
`)}},Jt=o=>[Math.trunc(255*o.r),Math.trunc(255*o.g),Math.trunc(255*o.b)],pr=o=>{let[e,t,r]=Jt(o);return"#"+((1<<24)+(e<<16)+(t<<8)+r).toString(16).slice(1)},Je=({property:o,value:e})=>`${o}: ${e};`;var ur=function(o,e,t,r){function i(s){return s instanceof t?s:new t(function(n){n(s)})}return new(t||(t=Promise))(function(s,n){function c(l){try{d(r.next(l))}catch(h){n(h)}}function a(l){try{d(r.throw(l))}catch(h){n(h)}}function d(l){l.done?s(l.value):i(l.value).then(c,a)}d((r=r.apply(o,e||[])).next())})},Qe=o=>ur(void 0,void 0,void 0,function*(){yield navigator.clipboard.writeText(o)}),Qt=({node:o,onClose:e})=>{if(!o)return null;let t=new be(o),r=i=>i.stopPropagation();return b`
  ...
  `},fr=o=>{let e=()=>Qe(o.getStyleSheet()),t=o.getStyles();return b`<div class="inspector-section">
  ...
  </div>`},gr=o=>{let{property:e,value:t,color:r}=o,i=null;switch(e){case"background":case"fill":case"border":case"box-shadow":case"color":i=b`<span
        class="color-preview"
...
`;var et=({node:o,selected:e=!1,computedThickness:t,onClick:r})=>{let{x:i,y:s,width:n,height:c}=o.absoluteBoundingBox,a="cornerRadius"in o&&o.cornerRadius?{topLeft:o.cornerRadius,topRight:o.cornerRadius,bottomRight:o.cornerRadius,bottomLeft:o.cornerRadius}:"rectangleCornerRadii"in o&&o.rectangleCornerRadii?{topLeft:o.rectangleCornerRadii[0],topRight:o.rectangleCornerRadii[1],bottomRight:o.rectangleCornerRadii[2],bottomLeft:o.rectangleCornerRadii[3]}:{topLeft:0,topRight:0,bottomRight:0,bottomLeft:0},d=t/2,l=(g,x)=>`M${g},${x}`,h=(g,x)=>`L${g},${x}`,u=(g,x,S)=>`A${g},${g} 0 0 1 ${x},${S}`,f=[l(a.topLeft+d,d),h(n-a.topRight,d),u(a.topRight-d,n-d,a.topRight),h(n-d,c-a.bottomRight),u(a.bottomRight-d,n-a.bottomRight,c-d),h(a.bottomLeft,c-d),u(a.bottomLeft-d,d,c-a.bottomLeft),h(d,a.topLeft),u(a.topLeft-d,a.topLeft,d),"Z"].join(" ");return C`
    <path
      class="guide"
      d=${f}
      shape-rendering="geometricPrecision"
...
`;var yr=[{gte:31536e6,divisor:31536e6,unit:"year"},{gte:2592e6,divisor:2592e6,unit:"month"},{gte:6048e5,divisor:6048e5,unit:"week"},{gte:864e5,divisor:864e5,unit:"day"},{gte:36e5,divisor:36e5,unit:"hour"},{gte:6e4,divisor:6e4,unit:"minute"},{gte:3e4,divisor:1e3,unit:"seconds"},{gte:0,divisor:1,text:"just now"}],ro=o=>(typeof o=="object"?o:new Date(o)).getTime(),io=(o,e=Date.now(),t=new Intl.RelativeTimeFormat(void 0,{numeric:"auto"}))=>{let i=ro(e)-ro(o),s=Math.abs(i);for(let n of yr)if(s>=n.gte){let c=Math.round(Math.abs(i)/n.divisor),a=i<0,d=n.unit;return d?t.format(a?c:-c,d):n.text}};var so=A`
  .figma-footer {
    flex: 0;
    z-index: calc(var(--z-index) + 1);
  ...
  >
    ...
    >
      Edited ${io(t)}
        ...
        "
          >
            ${Object.entries(this.__images).map(([f,g])=>{var x;let S=M(this,s,"f").call(this,f);if(!S||!("absoluteBoundingBox"in S)||!(!((x=M(this,t,"f"))===null||x===void 0)&&x[S.id]))return null;let w=M(this,t,"f")[S.id];return b`
                <img
            ...
            >
              ...
              ${M(this,r,"f").map(f=>{var g;return f.id===((g=this.selectedNode)===null||g===void 0?void 0:g.id)?null:C`
                  <g>
    ...
    `}getMetadata(){return{fileName:this.documentNode.name,timestamp:this.documentNode.lastModified,link:this.link}}connectedCallback(){super.connectedCallback(),this.documentNode&&(ot(this,_e,"f").call(this),this.selectedPage&&(this.__updateTree(this.selectedPage),this.resetZoom()))}updated(e){super.updated(e),e.has("documentNode")&&(ot(this,_e,"f").call(this),this.selectedPage&&(this.__updateTree(this.selectedPage),this.resetZoom())),e.has("renderedImages")&&this.__updateEffectMargins()}};_e=new WeakMap,rt=new WeakMap;co([E({type:Object,attribute:"document-node"})],j.prototype,"documentNode",void 0);co([E({type:Object,attribute:"rendered-images"})],j.prototype,"renderedImages",void 0);customElements.get("figspec-file-viewer")||customElements.define("figspec-file-viewer",j);customElements.get("figspec-frame-viewer")||customElements.define("figspec-frame-viewer",U);var _r=new Set(["children","localName","ref","style","className"]),ho=new WeakMap,$r=(o,e,t,r,i)=>{let s=i?.[e];s===void 0||t===r?t==null&&e in HTMLElement.prototype?o.removeAttribute(e):o[e]=t:((n,c,a)=>{let d=ho.get(n);d===void 0&&ho.set(n,d=new Map);let l=d.get(c);a!==void 0?l===void 0?(d.set(c,l={handleEvent:a}),n.addEventListener(c,l)):l.handleEvent=a:l!==void 0&&(d.delete(c),n.removeEventListener(c,l))})(o,s,t)},Er=(o,e)=>{typeof o=="function"?o(e):o.current=e};function $e(o=window.React,e,t,r,i){let s,n,c;if(e===void 0){let f=o;({tagName:n,elementClass:c,events:r,displayName:i}=f),s=f.react}else s=o,c=t,n=e;let a=s.Component,d=s.createElement,l=new Set(Object.keys(r??{}));class h extends a{constructor(){super(...arguments),this.o=null}t(g){if(this.o!==null)for(let x in this.i)$r(this.o,x,this.props[x],g?g[x]:void 0,r)}componentDidMount(){var g;this.t(),(g=this.o)===null||g===void 0||g.removeAttribute("defer-hydration")}componentDidUpdate(g){this.t(g)}render(){let{_$Gl:g,...x}=this.props;this.h!==g&&(this.u=w=>{g!==null&&Er(g,w),this.o=w,this.h=g}),this.i={};let S={ref:this.u};for(let[w,Me]of Object.entries(x))_r.has(w)?S[w==="className"?"class":w]=Me:l.has(w)||w in c.prototype?this.i[w]=Me:S[w]=Me;return S.suppressHydrationWarning=!0,d(n,S)}}h.displayName=i??c.name;let u=s.forwardRef((f,g)=>d(h,{...f,_$Gl:g},f?.children));return u.displayName=h.displayName,u}var po=$e(le,"figspec-frame-viewer",U,{onNodeSelect:"nodeselect",onPositionChange:"positionchange",onScaleChange:"scalechange"}),uo=$e(le,"figspec-file-viewer",j,{onNodeSelect:"nodeselect",onPositionChange:"positionchange",onScaleChange:"scalechange"});var zc=__STORYBOOK_API__,{ActiveTabs:Vc,Consumer:Yc,ManagerContext:Wc,Provider:Gc,addons:Ee,combineParameters:Zc,controlOrMetaKey:Xc,controlOrMetaSymbol:qc,eventMatchesShortcut:Kc,eventToShortcut:Jc,isMacLike:Qc,isShortcutTaken:ed,keyToSymbol:td,merge:od,mockChannel:rd,optionOrAltSymbol:id,shortcutMatchesShortcut:sd,shortcutToHumanString:nd,types:it,useAddonState:ad,useArgTypes:ld,useArgs:cd,useChannel:dd,useGlobalTypes:hd,useGlobals:pd,useParameter:st,useSharedState:ud,useStoryPrepared:fd,useStorybookApi:gd,useStorybookState:fo}=__STORYBOOK_API__;var Sr=Object.defineProperty,ct=(o,e)=>()=>(o&&(e=o(o=0)),e),Ar=(o,e)=>{for(var t in e)Sr(o,t,{get:e[t],enumerable:!0})},Ce,go,mo,vo,dt=ct(()=>{Ce=({config:o,defer:e=!1})=>{let[t,r]=T(e?void 0:o.url),[i,s]=T(!1);return N(()=>{if(!e)return;let n=requestAnimationFrame(()=>{r(o.url)});return()=>cancelAnimationFrame(n)},[e,o.url]),N(()=>{s(!1)},[t]),p("div",{css:go},!i&&p(I,{css:mo},"Loading..."),p("iframe",{css:vo,src:t,allowFullScreen:o.allowFullscreen,onLoad:()=>s(!0)}))},go=P`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
The addon fallbacks to normal iframe mode.For more detail, please check <https://www.figma.com/developers/embed>.`),o),[o.url,o.allowFullscreen,o.embedHost]);return p(Ce,{defer:!0,config:e})}}),Eo={};Ar(Eo,{Figspec:()=>lt,default:()=>Ao});function Se(o){return o.status!==200?Promise.reject(o.statusText):o.json()}function Cr(o){if(o.accessToken)return o.accessToken;try{return m.STORYBOOK_FIGMA_ACCESS_TOKEN??null}catch{return null}}function So(o){return"absoluteBoundingBox"in o?[o]:!o.children||o.children.length===0?[]:o.children.map(So).reduce((e,t)=>e.concat(t),[])}var nt,lt,Ao,Mr=ct(()=>{$o(),nt=P`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
  left: 0;
`,lt=({config:o})=>{let[e,t]=T({state:"loading"}),r=async i=>{t({state:"loading"});try{let s=o.url.match(at);if(!s)throw new Error(o.url+" is not a valid Figma URL.");let[,,,n]=s,c=new URL(o.url).searchParams.get("node-id"),a=Cr(o);if(!a)throw new Error("Personal Access Token is required.");let d={"X-FIGMA-TOKEN":a},l=new URL(`https://api.figma.com/v1/files/${n}`),h=new URL(`https://api.figma.com/v1/images/${n}`);if(h.searchParams.set("format","svg"),!c){let g=await fetch(l.href,{headers:d,signal:i}).then(w=>Se(w)),x=So(g.document);h.searchParams.set("ids",x.map(w=>w.id).join(","));let S=await fetch(h.href,{headers:d,signal:i}).then(w=>Se(w));t({state:"fetched",value:{type:"file",props:{documentNode:g,renderedImages:S.images,link:o.url}}});return}l.pathname+="/nodes",l.searchParams.set("ids",c),h.searchParams.set("ids",c);let[u,f]=await Promise.all([fetch(l.href,{headers:d,signal:i}).then(g=>Se(g)),fetch(h.href,{headers:d,signal:i}).then(g=>Se(g))]);t({state:"fetched",value:{type:"frame",props:{nodes:u,renderedImage:Object.values(f.images)[0],link:o.url}}})}catch(s){if(s instanceof DOMException&&s.code===DOMException.ABORT_ERR)return;console.error(s),t({state:"failed",error:s instanceof Error?s.message:String(s)})}};switch(N(()=>{let i=!1,s=()=>{i=!0},n=new AbortController;return r(n.signal).then(s,s),()=>{i||n.abort()}},[o.url]),e.state){case"loading":return p(I,null,p(_,null,"Loading Figma file..."));case"failed":return p(I,null,p(_,null,"Failed to load Figma file"),p(_,null,e.error));case"fetched":return e.value.type==="file"?p(uo,{css:nt,...e.value.props}):p(po,{css:nt,...e.value.props})}},Ao=lt}),Co="STORYBOOK_ADDON_DESIGNS",bo=Co+"/panel",Ae="design",xo=class extends ke{constructor(){super(...arguments),this.state={hasError:!1}}static getDerivedStateFromError(o){return{hasError:!0,error:o}}componentDidCatch(o,e){console.group("An error occurred during rendering Addon panel of storybook-addon-designs"),console.log("--- Error ---"),console.error(o),console.log("--- React Component Stack ---"),console.error(e.componentStack),console.groupEnd()}render(){return this.state.hasError?p(I,null,p(_,null,"Failed to render addon UI"),p(_,null,p("p",null,"Sorry, this addon has crashed due to the below error has thrown during rendering the addon UI."),p("pre",null,String(this.state.error)),p("p",null,"See console log for more details. To clear the error state, please reload the page."," ",p(K,{href:"https://github.com/storybookjs/addon-designs/issues/new?assignees=&labels=category%3A+bug&template=bug_report.yml",target:"_blank",rel:"noopener",withArrow:!0,cancel:!1},"Bug report")))):this.props.children}};$o();dt();var kr=(o,e)=>{let[t,r]=T([0,0]),[i,s]=T(!1),n=k(u=>{u.button===0&&(r([u.screenX,u.screenY]),s(!0))},[s,r]),c=k(u=>{let f=u.touches[0];r([f.screenX,f.screenY]),s(!0)},[s,r]),a=k(u=>{i&&r(f=>(o([u[0]-f[0],u[1]-f[1]]),u))},[r,i,...e]),d=k(u=>{let{screenX:f,screenY:g}=u;a([f,g])},[a]),l=k(u=>{let{screenX:f,screenY:g}=u.touches[0];a([f,g])},[r,i,...e]),h=k(()=>{r([0,0]),s(!1)},[s,r]);return{onMouseDown:n,onMouseMove:d,onMouseUp:h,onMouseLeave:h,onTouchStart:c,onTouchMove:l,onTouchCancel:h,onTouchEnd:h}},Tr=({children:o,className:e,style:t,defaultValue:r,value:i,onChange:s})=>{let[n,c]=T([0,0]);N(()=>{c(r||i||[0,0])},[r]);let a=kr(l=>{s&&s(l),c(h=>[h[0]+l[0],h[1]+l[1]])},[c,s]),d=W(()=>{let l=i||n;return{transform:`translate(${l[0]}px, ${l[1]}px)`}},[i,n]);return p("div",{css:Pr,className:e,style:t,...a},p("div",{css:Nr,style:d},o))},Pr=P`
  position: relative;
  overflow: hidden;
...
`,Nr=P`
  ...
  bottom: 0;
  left: 0;
`,Rr=({onZoomIn:o,onZoomOut:e,onReset:t})=>p(_,null,p(ce,{onClick:o},p(de,{icon:"zoom"})),p(ce,{onClick:e},p(de,{icon:"zoomout"})),p(ce,{onClick:t},p(de,{icon:"zoomreset"}))),Or=(o,e)=>{let[t,r]=T(1);N(()=>{r(o)},e);let i=k(()=>{r(c=>c+.1)},[r]),s=k(()=>{r(c=>Math.max(c-.1,.1))},[r]),n=k(()=>{r(1)},[r]);return{scale:t,zoomIn:i,zoomOut:s,resetZoom:n}},Br=({config:o})=>{let e=Or(o.scale||1,[o.scale]),t=W(()=>({transform:`scale(${e.scale})`}),[e.scale]);return p("div",{css:Lr},p(pt,{border:!0},p(_,{key:"left"},p("p",null,p("b",null,"Image")),p(ut,null),p(Rr,{onReset:e.resetZoom,onZoomIn:e.zoomIn,onZoomOut:e.zoomOut}))),p(Tr,{css:Hr,defaultValue:o.offset},p("img",{css:Ir,src:o.url,style:t})))},Lr=P`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`,Fr=({config:o})=>p("div",{css:Ur},p(K,{cancel:!1,href:o.url,target:o.target??"_blank",rel:o.rel??"noopener",withArrow:o.showArrow??!0},o.label||o.url)),Ur=P`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
  ...
  align-items: center;
`;dt();var jr=o=>{if(o.protocol!=="https:")return{valid:!1,error:p(_,null,"Expected HTTPS link, received ",p("code",null,o.protocol),".")};if(o.hostname!=="www.sketch.com")return{valid:!1,error:p(_,null,"Expected a hostname ",p("code",null,"www.sketch.com"),", received"," ",p("code",null,o.hostname))};let e=p(_,null,"Expected pathname ",p("code",null,"/s/<string>/a/<string>"),", received"," ",p("code",null,o.pathname),"."),t=o.pathname.split("/").slice(1);if(t.length<4)return{valid:!1,error:e};if(t[0]==="embed")return{valid:!0,data:{url:o.href,offscreen:!1}};let[r,i,s,n]=t;return r!=="s"||!i||s!=="a"||!n?{valid:!1,error:e}:{valid:!0,data:{url:`https://www.sketch.com/embed/s/${i}/a/${n}`,offscreen:!1}}},Dr=({config:o})=>{let e=W(()=>{let t=jr(new URL(o.url));return t.valid?{...t,data:{...o,...t.data}}:t},[o]);return e.valid?p(Ce,{defer:!0,config:e.data}):p(I,null,p(_,null,"Invalid Sketch URL"),p(_,null,e.error))},zr=({tabs:o,deps:e=[]})=>{let[t,r]=T(o[0].id);return N(()=>{r(o[0].id)},e),p(ft,{absolute:!0,selected:t,actions:{onSelect:r}},o.map(i=>p("div",{key:i.id,id:i.id,title:i.name},i.offscreen||t===i.id?i.content:null)))},Vr=Pe(()=>Promise.resolve().then(()=>(Mr(),Eo))),Yr=({config:o})=>{if(!o||"length"in o&&o.length===0)return p(I,null,p(_,null,"No designs found"),p(_,null,"Learn how to"," ",p(K,{href:"https://github.com/storybookjs/addon-designs#3-add-it-to-story",target:"_blank",rel:"noopener",withArrow:!0,cancel:!1},"display design preview for the story")));let e=[...o instanceof Array?o:[o]].map(t=>{let r={id:JSON.stringify(t),name:t.name||t.type?.toUpperCase()||"ERROR",offscreen:t.offscreen??!0};switch(t.type){case"iframe":return{...r,content:p(Ce,{config:t})};case"figma":return{...r,content:p(_o,{config:t}),offscreen:!1};case"sketch":return{...r,content:p(Dr,{config:t})};case"figspec":case"experimental-figspec":return t.type==="experimental-figspec"&&console.warn("[storybook-addon-designs] `experimental-figspec` is deprecated. We will remove it in v7.0. Please replace it to `figspec` type."),{...r,content:p(Te,{fallback:"Preparing Figspec viewer..."},p(Vr,{config:t})),offscreen:!1};case"image":return{...r,content:p(Br,{config:t})};case"link":return{...r,content:p(Fr,{config:t})}}return{...r,content:p(I,null,p(_,null,"Invalid config type"),p(_,null,"Config type you set is not supported. Please choose one from"," ",p(K,{href:"https://github.com/storybookjs/addon-designs/blob/master/packages/storybook-addon-designs/src/config.ts",target:"_blank",rel:"noopener",withArrow:!0,cancel:!1},"available config types")))}});return e.length===1?p("div",null,e[0].content):p(zr,{tabs:e,deps:[o]})},wo=({active:o})=>{let e=fo(),t=st(Ae),[r,i]=T(o);return N(()=>{i(o)},[t]),N(()=>{o&&i(!0)},[o]),r?p(Yr,{key:e.storyId,config:t}):null},ae="Design";function Wr(o){Ee.register(Co,e=>{let t=function(){let r=st(Ae);return r?Array.isArray(r)?r.length>0?`${ae} (${r.length})`:ae:(r.name||ae)+" (1)":ae};o==="tab"?Ee.add(bo,{title:ae,render({active:r}){return r?p(xo,null,p(wo,{active:!0})):p("noscript",null)},type:it.TAB,paramKey:Ae}):Ee.add(bo,{type:it.PANEL,title:t,paramKey:Ae,render({active:r}){return p(ht,{active:!!r},p(xo,null,p(wo,{active:!!r})))}})})}Wr("panel");})();

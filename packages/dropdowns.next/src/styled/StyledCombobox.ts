...
const COMPONENT_ID = 'comboboxes.combobox';

export interface IStyledComboboxProps extends ThemeProps<DefaultTheme> {
  isCompact?: boolean;
}

const colorStyles = (props: IStyledComboboxProps) => {

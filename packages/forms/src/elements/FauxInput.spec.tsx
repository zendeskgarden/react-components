...
describe('FauxInput', () => {
  ...
  it('applies focused styling on focus event', () => {
    ...
    expect(container.firstElementChild!.getAttribute('data-garden-focus-visible')).toBe('false');

    fireEvent.focus(container.firstElementChild!);

    expect(container.firstElementChild!.getAttribute('data-garden-focus-visible')).toBe('true');
  });

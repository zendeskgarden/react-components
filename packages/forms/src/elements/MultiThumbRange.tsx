...
export const MultiThumbRange = forwardRef<HTMLDivElement, IMultiThumbRangeProps>(
  ({ min, max, minValue, maxValue, disabled, step, onChange, onMouseDown, ...props }, ref) => {
    ...
    const calculateUpdatedValue = useCallback(
      (e: React.MouseEvent) => {
        ...
        const trackOffsetRight =
          trackOffsetLeft + trackRailRef.current.getBoundingClientRect().width;

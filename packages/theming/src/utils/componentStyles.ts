 ...
 *
 * @param {Object} options.theme Provides `components` object use to resolve the given component ID
 * @param {String} [options.componentId] Specifies the lookup id for * `theme.components` styles.

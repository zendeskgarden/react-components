...
import { DefaultThemeExample } from './examples/DefaultThemeExample';

<Meta title="Components/Theming/Elements/DEFAULT_THEME" />
...
in conjunction with the **Colors** values described above, you have the power

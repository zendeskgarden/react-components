...
describe('scrollIntoView()', () => {
  ...
  it('does nothing if parent.top is above view area and node within view', () => {
  ...
  it('aligns to top when the node is above view area', () => {
  ...
  it('aligns to top of view area when the node is above view area and scrollable parent top', () => {
  ...
  it('aligns to top of scrollable parent when the node is above view area', () => {
  ...
  it('aligns to bottom when the node is below the scrollable parent and parent top above view area', () => {

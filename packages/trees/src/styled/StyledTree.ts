...
const COMPONENT_ID = 'trees.tree';

export interface IStyledTreeProps extends ThemeProps<DefaultTheme> {
  isCompact?: boolean;
}

const colorStyles = (props: IStyledTreeProps) => {
...
const sizeStyles = (props: IStyledTreeProps) => {
...
export const StyledTree = styled.div.attrs<IStyledTreeProps>({

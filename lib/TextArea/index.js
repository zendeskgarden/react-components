...
var TextArea = function (_ThemedComponent) {
  ...
  TextArea.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        other = (0, _objectWithoutProperties3.default)(_props, ["className", "disabled", "hint", "type", "resizable", "size", "title", "tooltipPositioning", "validation", "validationText"]);
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(_Core2.default, (0, _extends3.default)({}, other, {
        disabled: disabled,
        className: (0, _classnames2.default)(theme.input, (_classNames2 = {}, _classNames2[theme.resizable] = resizable, _classNames2[theme.style_bare] = type === "bare", _classNames2), className),
        id: this.getId(),

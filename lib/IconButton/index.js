...
var IconButton = function (_ThemedComponent) {
  ...
  IconButton.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        other = (0, _objectWithoutProperties3.default)(_props, ['children', 'isRotated']);

    var theme = this.theme;

    return _react2.default.createElement(
      _Button2.default,
      (0, _extends3.default)({ className: _styles2.default.button }, other),
      typeof children === 'string' ? children : _react2.default.cloneElement(_react.Children.only(children), {
        className: (0, _classnames2.default)(_styles2.default.icon, (_classNames = {}, _classNames[theme.rotated] = isRotated, _classNames))
      })
    );
  };

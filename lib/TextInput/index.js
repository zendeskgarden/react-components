...
var TextInput = function (_ThemedComponent) {
  ...
  TextInput.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        other = (0, _objectWithoutProperties3.default)(_props, ['className', 'disabled', 'hint', 'size', 'title', 'tooltipPositioning', 'validation', 'validationText', 'valueType']);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.renderLabel = function () {
    var label = _this3.props.label;
    var theme = _this3.theme;
    ...
    return _react2.default.createElement(
      'label',
      { className: theme.label, htmlFor: _this3.getId() },
      label
    );
  };
};

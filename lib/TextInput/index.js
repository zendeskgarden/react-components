...
var TextInput = function (_ThemedComponent) {
  ...
  TextInput.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        other = (0, _objectWithoutProperties3.default)(_props, ['className', 'hint', 'title', 'tooltipPositioning', 'validation', 'valueType']);
    ...
    return _react2.default.createElement(
      _View2.default,
      {
        className: (0, _classnames2.default)(theme.txt, theme[validation]),
        title: title,
...
TextInput.propTypes = {
  ...
  validation: _react.PropTypes.oneOf(['error', 'warning', 'success']),
  value: _react.PropTypes.string,
  valueType: _react.PropTypes.oneOf(['email', 'number', 'password', 'search', 'tel', 'text'])
};

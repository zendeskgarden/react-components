...
var TextInput = function (_ThemedComponent) {
  ...
  TextInput.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        other = (0, _objectWithoutProperties3.default)(_props, ["className", "disabled", "hint", "size", "title", "tooltipPositioning", "type", "validation", "validationText", "valueType"]);
    ...
    return _react2.default.createElement(
      _View2.default,
      {
        className: (0, _classnames2.default)(theme.txt, theme["size_" + size], theme[validation], (_classNames = {}, _classNames[theme.disabled] = disabled, _classNames)),
        title: title,

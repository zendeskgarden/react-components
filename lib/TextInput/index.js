...
var TextInput = function (_ThemedComponent) {
  ...
  TextInput.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        other = (0, _objectWithoutProperties3.default)(_props, ["className", "dir", "disabled", "hint", "size", "title", "tooltipPositioning", "type", "validation", "validationText", "valueType"]);
    ...
    return _react2.default.createElement(
      _View2.default,
      {
        className: (0, _classnames2.default)(theme.txt, theme["size_" + size], theme[validation], (_classNames = {}, _classNames[theme.disabled] = disabled, _classNames[theme.rtl] = dir === "rtl", _classNames)),
        title: title,
      ...
      _react2.default.createElement(_Core2.default, (0, _extends3.default)({}, other, {
        ...
        valueType: valueType,
        id: this.getId(),
        className: (0, _classnames2.default)(theme.input, className, (_classNames2 = {}, _classNames2[theme.style_bare] = type === "bare", _classNames2)),
...
TextInput.propTypes = {
  ...
  valueType: _propTypes2.default.oneOf(["date", "datetime-local", "email", "month", "number", "password", "search", "tel", "text", "url", "week"])
};

...
var Checkbox = function (_ThemedComponent) {
  ...
  Checkbox.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      _View2.default,
      {
        className: (0, _classnames2.default)(theme.checkbox, theme[validation], (_classNames = {}, _classNames[theme.focused] = focused, _classNames[theme.rtl] = dir === "rtl", _classNames[theme.disabled] = disabled, _classNames[theme.noLabel] = !children, _classNames[theme.indeterminate] = indeterminate, _classNames)),
        title: title,

...
var ReactSingleSelectionModel = function () {
  function ReactSingleSelectionModel() {
    ...
    _classCallCheck(this, ReactSingleSelectionModel);
    ...
    this.choseSelection = function (event) {
      if (_this.hasSelection()) {
        ...
        _this.onValueChosen && _this.onValueChosen(value, event);
        return true;
      }
    };
    ...
    this.reactivate = function (defaultSelection) {
      _this.model.reactivate(defaultSelection);
    };
    ...
    this.model = new SingleSelectionModel({ wrapping: wrapping });
  ...
  _createClass(ReactSingleSelectionModel, [{
    key: "items",
    set: function set(items) {
      ...
      React.Children.forEach(this._items, function (item) {
    ...
    get: function get() {
      ...
      return React.Children.map(this._items, function (child) {
...
export default ReactSingleSelectionModel;
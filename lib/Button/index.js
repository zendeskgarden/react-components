...
var Button = function (_ThemedComponent) {
  ...
  Button.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        size = _props.size,
        type = _props.type,
        other = (0, _objectWithoutProperties3.default)(_props, ["className", "children", "danger", "disabled", "stretched", "pill", "size", "type"]);
    ...
    return _react2.default.createElement(
      ...
      (0, _extends3.default)({}, other, {
        ...
        className: (0, _classnames2.default)(theme["size_" + size], (_classNames = {}, _classNames[typeStyle] = typeStyle, _classNames[theme.focused] = focused, _classNames[theme.pill] = pill, _classNames[theme.stretched] = stretched, _classNames[theme.disabled] = disabled, _classNames[theme.active] = active, _classNames[theme.danger] = danger, _classNames), className)
      }),
      children
    );
  };

...
var Label = function (_ThemedComponent) {
  ...
  Label.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      _View2.default,
      {
        className: (0, _classnames2.default)(theme[type], theme[size], (_classNames = {}, _classNames[theme.pill] = pill, _classNames[theme.round] = round, _classNames[theme.rtl] = dir === "rtl", _classNames[theme.stretched] = stretched, _classNames), className),

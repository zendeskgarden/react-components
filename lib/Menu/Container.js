...
var Container = function (_ThemedComponent) {
  ...
  Container.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      _View2.default,
      {
        className: (0, _classnames2.default)(theme.menu, theme["size_" + size], theme["position_" + position], theme[dir], (_classNames = {}, _classNames[theme.animate] = animate, _classNames[theme.fixed_width] = fixedWidth, _classNames[theme.arrow] = arrow, _classNames[theme["arrow_" + arrowPositions[position]]] = arrow, _classNames[theme.scrollable] = hasMaxHeight, _classNames[theme.wide] = wide, _classNames)),
        role: "menu",
        style: style
      },

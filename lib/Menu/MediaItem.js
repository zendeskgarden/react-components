...
var MediaItem = function (_ThemedComponent) {
  (0, _inherits3.default)(MediaItem, _ThemedComponent);

  function MediaItem(props, context) {
    (0, _classCallCheck3.default)(this, MediaItem);
  ...
  MediaItem.prototype.render = function render() {
    var _props = this.props,
        ...
        otherProps = (0, _objectWithoutProperties3.default)(_props, ["children", "className", "media", "metaInformation"]);
    var theme = this.theme;


    return _react2.default.createElement(
      _Item.Item,
      (0, _extends3.default)({ className: (0, _classnames2.default)(className, theme.media_item) }, otherProps),
      media && _react2.default.createElement(
        "div",
        { className: theme.media_figure },
        media
      ),
      _react2.default.createElement(
        "div",
        { className: theme.media_body },
        children,
...
exports.default = (0, _Selectable2.default)(MediaItem, {

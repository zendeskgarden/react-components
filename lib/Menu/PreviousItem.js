...
var PreviousItem = function (_ThemedComponent) {
  (0, _inherits3.default)(PreviousItem, _ThemedComponent);

  function PreviousItem(props, context) {
    (0, _classCallCheck3.default)(this, PreviousItem);
  ...
  PreviousItem.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      _Item.Item,
      (0, _extends3.default)({
        className: (0, _classnames2.default)(className, theme.previous_item)
      }, otherProps),
      children
    );
  };
...
exports.default = (0, _Selectable2.default)(PreviousItem, {

...
var Modal = function (_ThemedComponent) {
  ...
  Modal.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      _View2.default,
      {
        className: (0, _classnames2.default)(theme.backdrop, theme[dir]),
        onClick: onClose,
        onEscape: onClose,
        onTab: this.onTab,
      ...
      _react2.default.createElement(
        _View2.default,
        {
          ...
          className: (0, _classnames2.default)(theme.dialog, theme["size_" + size], theme[dir], (_classNames = {}, _classNames[theme.open] = !hidden, _classNames)),
...
Modal.propTypes = {
  ...
  type: (0, _reactIsDeprecated.deprecate)(_propTypes2.default.oneOf(["default", "transparent", "lightbox"]), "The Modal component 'type' prop is deprecated and will be removed in a future version."),

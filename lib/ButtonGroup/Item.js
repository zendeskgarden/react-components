  ...
  Item.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      "button",
      {
        ...
        className: (0, _classnames2.default)(theme.type_default, theme["size_" + size], (_classNames = {}, _classNames[theme.disabled] = disabled, _classNames[theme.selected] = active, _classNames[theme.focused] = !selectedByMouse && selected, _classNames)),
        onClick: onClick,

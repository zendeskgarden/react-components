...
var Table = function (_ThemedComponent) {
  ...
  function Table(props, context) {
    ...
    _this.applyKeyboardActions = function (tableReference) {
      ...
      if (!_this.tableRef && tableReference) {
        ...
        _gridElement.removeEventListener("focusout", focusOut);
  ...
  Table.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        otherTableProps = (0, _objectWithoutProperties3.default)(_props, ["className", "data", "density", "dir", "rowRenderer", "onRowsRendered", "useAutoSizer"]);

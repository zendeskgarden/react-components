...
var Select = function (_ThemedComponent) {
  ...
  Select.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      _View2.default,
      {
        className: (0, _classnames2.default)(theme.txt, theme[validation], theme["size_" + size], (_classNames = {}, _classNames[theme.rtl] = dir === "rtl", _classNames[theme.stretched] = stretched, _classNames[theme.disabled] = disabled, _classNames), className),
        testId: testId
      },
      this.renderLabel(),

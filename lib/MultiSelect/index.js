...
var MultiSelect = function (_ThemedComponent) {
  ...
  function MultiSelect(props, context) {
    ...
    _this.onMenuValueChosen = function (value, event) {
      var onMenuValueSelected = _this.props.onMenuValueSelected;


      var closingAction = function closingAction() {
        onMenuValueSelected && onMenuValueSelected(value, event);
        // this.onClose();
        _this.textInputNode.focus();
      };
    ...
    _this.renderAnchorElement = function () {
      ...
      var _this$props2 = _this.props,
          ...
          showChevron = _this$props2.showChevron,
      ...
      return _react2.default.createElement(
        _View2.default,
        {
          className: (0, _classnames2.default)(theme.input, (_classNames = {}, _classNames[theme.open] = open && menuItems && menuItems.length > 0, _classNames[theme.no_chevron] = !showChevron || inputMaxHeight, _classNames[theme.input_overflow] = inputMaxHeight, _classNames)),
...
MultiSelect.propTypes = {
  ...
  showChevron: _propTypes2.default.bool,
